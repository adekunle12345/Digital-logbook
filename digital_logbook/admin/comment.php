    ...
    <form action="com-val.php" method="POST">
        <div class="notes" id="app" style="margin-left: 20%;">
            ...
            <div class="notes__preview" style="">
                <input class="notes__title" type="text" name="week" placeholder="(Week 1:  July 23rd - 28th) " style="width: 76.5%; margin-bottom:0; padding: 0.5em 0 0.5em 0.5em; border: 1px solid black; font-size: 1.5em">
                <textarea class="notes__body" name="comment" placeholder="Comments by Industry-Based Supervisor" style="height:15em; width:74%; border: 1px solid black; padding: 1em 1em; margin-bottom:0"></textarea>
            </div>
        </div>
